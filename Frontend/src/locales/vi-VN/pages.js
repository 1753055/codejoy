export default {
  'pages.layouts.userLayout.title':
    'CodeJoy là sự lựa chọn tốt nhất cho bạn!',
  ...
  'pages.login.username.required': 'Vui lòng nhập tên tài khoản của bạn!',
